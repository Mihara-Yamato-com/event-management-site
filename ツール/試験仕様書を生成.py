...
LEGEND_ROWS = [
    ...
    ('', '大項目 / 中項目 / 小項目', 'テスト対象の分類。大きな機能名→具体的な項目、の順に細かくなります。'),
    ('', '観点', 'そのテストで「何を確かめるか」の種類（下の観点セクションを参照）。'),
    ('', '前提条件', 'テストを始める前に整えておく状態・準備。'),
    ('', '手順', '実際に行う操作の手順。'),
    ('', '期待結果', '操作後に「こうなっていれば正しい」という状態。'),
    ('', '結果（OK / NG）', 'OK＝期待どおり動いた。NG＝期待どおりにならなかった（不具合）。'),
    ('', 'AI', 'AI が提案した項目である場合に「利用」と記入します。'),
    ...
    ('用語', 'F-xx / S-xx / D-xx', '機能ID・画面ID・入力仕様ID。機能一覧.md / 画面一覧.md / 仕様決定シート.md と対応します。'),
